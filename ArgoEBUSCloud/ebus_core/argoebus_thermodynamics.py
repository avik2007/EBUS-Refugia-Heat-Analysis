# this script will contain the scripts that allow  for the calculation of thermodynamic quantities
# this is something like the ArgoHeatContentDataCollater.py in ArgoEBUSAnalysis folder

# we will put a few  preexisting scripts in here:
# 1. calculate_thermodynamics()
# 2. compute_ohc_layer()
# 3. estimate_ohc_from_raw_bins()
